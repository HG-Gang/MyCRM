...
@section('content')
    @if($_global_role['para_data0'] == '1')
        <div class="not-allow_withdrawals">
            ...
            <span class="span-text-bottom">
                <h2>目前出金通道正在维护，如果需要出金，请用注册邮箱发送出金申请至:cs@boruimarkets.com</h2>
            </span>
        </div>
    ...
    @elseif($_user_info['user_id'] == 318046)
    ...
    <div class="deposit-matter" >
        ...
        <p>4.在线申请出金单笔收取千分之三(3‰)人民币作为手续费, 单笔最大可取金额不能大于<span style="color: red">$7000</span>。</p>
...
@section('custom-resources')
    <script type="text/javascript">
        function checkWithdrawAmt() {
            ...
            } else if (withdraw_amt != "" && Number(withdraw_amt) < 19) {
                errorTips("请输入大于$19的取款金额!", "msg", "withdraw_amt");
