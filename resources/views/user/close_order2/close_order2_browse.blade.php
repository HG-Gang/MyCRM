...
@section('content')
	<form class="layui-form" action="" id="CloseOrder2Form" style="margin-top: 8px;">
...
@section('custom-resources')
	<script type="text/javascript">
		function dataGridConfig() {
			var config = {};
			config.DataColumns = [[
				{field:'ticket', title:'{{ trans ('systemlanguage.close_order_ticket_id') }}', width:100, align:'center',},
				{field:'login', title:'{{ trans ('systemlanguage.close_order_user_id') }}', width:100, align:'center',},
		...
		function DbClickEditAccountInfo(rowIndex, rowData) {
			console.log("没有可以查看的信息");
		}
		
		function createTable() {
			var config = dataGridConfig(), pagerData;
			pagerData = new $.WidgetPage({
				reqUrl: '/user/close/closeOrder2Search',
				tableId: 'data_list',
				formId: 'CloseOrder2Form',
				method: 'post',
