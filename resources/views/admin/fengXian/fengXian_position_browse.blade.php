			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select name="orderType" id="orderType">
						...
						<option value="real_disk" selected>真实盘</option>
	...
	<script type="text/javascript">
		...
		function dataGridConfig() {
			...
			config.DataColumns = [[
				...
				{field:'login' ,title:'{{ trans ('systemlanguage.open_order_user_id') }}', width:100, align:'center',},
				...
				{field:'feng_xian_positionval' ,title:'{{ trans ('systemlanguage.open_order_feng_xian_val') }}', width:100, align:'center', formatter: function (value, rowData, rowIndex) {
					return value + "%";
				}},
		...
		function createTable() {
			...
			pagerData = new $.WidgetPage({
				reqUrl: route_prefix() + '/fengXian/positionSearch',
				tableId: 'data_list',
