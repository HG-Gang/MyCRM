    ...
    <form class="layui-form" action="" id="AdminWithdrawApplyDetailForm" style="margin-top: 8px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="act_pdg_rmb" id="act_pdg_rmb" value="{{ $_order_info['act_pdg_rmb'] }}" autocomplete="off" placeholder="请输入手续费" class="layui-input" readonly="readonly" style="width: 200px; border: 1px solid #ccc; background: #E6E6FA !important; color: #0066ff; cursor:text;">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                @if($_order_info['apply_status'] == 2)
                    <input type="radio" name="apply_status" value="2" title="已出款" checked>
                @else
                    <input type="radio" name="apply_status" value="2" title="已出款">
                @endif
                @if($_order_info['apply_status'] == 3)
                    <input type="radio" name="apply_status" value="3" title="处理失败" checked>
                @else
                    <input type="radio" name="apply_status" value="3" title="处理失败">
                @endif
            </div>
        </div>
        @if($_order_info['apply_status'] == 3)
        ...
        function orderConfirm() {
            if (!$("#confirmBtn").hasClass("layui-btn-disabled")) {
                if (check_order_status()) {
                    ...
                    $.ajax({
                        url: route_prefix() + "/amount/order_status",
                        data: {
