    ...
    <form class="layui-form" action="" id="AdminCustListForm" style="margin-top: 8px;">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="username" id="username" value="{{ $_acc_info['user_name'] }}"autocomplete="off" placeholder="请输入账户姓名" class="layui-input" style="width: 200px;">
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="userphoneNo" id="userphoneNo" value="{{ substr($_acc_info['phone'], (stripos($_acc_info['phone'], '-') + 1)) }}"autocomplete="off" placeholder="请输入手机号" class="layui-input" style="width: 200px;">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">邮箱</label>
                <div class="layui-input-block">
                    <input type="text" name="useremail" id="useremail" value="{{ $_acc_info['email'] }}"autocomplete="off" placeholder="请输入邮箱" class="layui-input" style="width: 200px;">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <div class="layui-input-block">
                    <button type="button" class="layui-btn" onclick="custSave_1('{{ csrf_token() }}')">确定</button>
                </div>
            </div>
            <div class="layui-inline">
                <div class="layui-input-block" style="margin-left: 50px;">
                    <button type="button" class="layui-btn" id="sendSms" onclick="againSendSMS('{{ $_acc_info['user_id'] }}' ,'{{ csrf_token() }}')">发送短信</button>
                </div>
            </div>
        </div>
    </form>
