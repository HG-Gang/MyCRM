<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="form-child-div">
        ...
        <input type="text" class="input-text" autocomplete="off" value="{{$user->email}}" placeholder="邮箱" id="email" name="email">
    </div>
    <div class="form-child-div">
        <label class="find-font">&nbsp;&nbsp;&nbsp;手机号：</label>                  
        <input type="text" class="input-text" autocomplete="off" value="{{substr($user->phone,3)}}" placeholder="手机号" id="phone" name="phone">
    </div>
    <div class="form-child-div">
        <label class="find-font">&nbsp;&nbsp;&nbsp;用户组：</label>                  
        <select class="input-text" name="mt4_grp" size="1">
    ...
    <div class="form-child-div">
        ...
        <input type="text" class="input-text" autocomplete="off" value="{{$user->parent_id}}" placeholder="上级代理" id="parent_id" name="parent_id">
    </div>
    <div class="form-child-div">
    ...
    <div class="form-child-div">
        ...
        <select class="input-text" name="group_id" size="1">              
    ...
    <div class="form-child-div">
        ...
        <input type="text" class="input-text" autocomplete="off" value="{{$user->comm_prop}}" placeholder="返佣比例" id="comm_prop" name="comm_prop">
    </div>
    <div class="form-child-div" style="height: 31px;line-height: 31px;">
        <label class="find-font" for="enable">账户启用：</label>  <input type="checkbox"  name="enable" id="enable"  class="check1" @if($user->enable==1) checked @endif>                 
                                                                    <label class="find-font" for="enable_readonly">只读账户：</label>  <input type="checkbox"  name="enable_readonly" id="enable_readonly"  class="check1" @if($user->enable_readonly==0) checked @endif> 
                                                                    <label class="find-font" for="is_out_money">出金锁定：</label>  <input type="checkbox"  name="is_out_money" id="is_out_money"  class="check1" @if($user->is_out_money==1) checked @endif> 
    </div>
    <div class="form-child-div">
        <label class="find-font">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注：</label>                  
        <input type="text" class="input-text" autocomplete="off" value="{{$user->remark}}" placeholder="备注" id="remark" name="remark">
    </div>
    <div class="form-child-div">
