    ...
    <form class="layui-form" action="" id="AdminAgentsListForm" style="margin-top: 8px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="userphoneNo" id="userphoneNo" value="{{ substr_replace(substr($ag_info['phone'], (stripos($ag_info['phone'], '-') + 1)), '*****', 3, -3) }}"autocomplete="off" placeholder="请输入手机号" class="layui-input" readonly="readonly" style="width: 200px; border: 1px solid #ccc; background: #E6E6FA !important; color: #0066ff; cursor:text;">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">邮箱</label>
                <div class="layui-input-block">
                    <input type="text" name="useremail" id="useremail" value="{{ substr_replace($ag_info['email'], '*****', 3, (stripos($ag_info['email'], '@') - 3)) }}"autocomplete="off" placeholder="请输入邮箱" class="layui-input" readonly="readonly" style="width: 200px; border: 1px solid #ccc; background: #E6E6FA !important; color: #0066ff; cursor:text;">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
			...
			<div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="cust_lvg" id="cust_lvg" value="{{ $ag_info['cust_lvg'] }}" autocomplete="off" readonly="readonly" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入交易杠杆" maxlength="3" class="layui-input" readonly="readonly" style="width: 200px; border: 1px solid #ccc; background: #E6E6FA !important; color: #0066ff; cursor:text;">
                </div>
            </div>
            <div class="layui-inline">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    ...
                    @if($ag_info['enable_readonly'] == 1)
                        {{--勾上，只读 能登录 不能交易--}}
                        <input type="checkbox" name="enable_readonly" id="enable_readonly" value="1" lay-skin="primary" title="只读" checked="">
                    @else
                        {{--未勾上，能登录 交易--}}
                        <input type="checkbox" name="enable_readonly" id="enable_readonly" value="0" lay-skin="primary" title="只读">
                    @endif
