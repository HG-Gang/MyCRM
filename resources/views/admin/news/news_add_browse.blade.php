...
@section('content')
    <form class="layui-form" action="" id="AdminNewsForm" style="margin-top: 8px;">
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">新闻标题</label>
                <div class="layui-input-block">
                    <input type="text" name="newstitle" id="newstitle" autocomplete="off" placeholder="请输入新闻标题" class="layui-input" style="width: 724px;">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script type="text/javascript">
        ...
        function check_title_content() {
            if ($.trim($("#newstitle").val()) == "") {
                ...
                errorTips("新闻内容不能为空!", "msg", "container");
            } else {
                return true;
            }
        }
        ...
        function saveNews() {
            if (check_title_content()) {
                ...
                $.ajax({
                    url: route_prefix() + "/news/news_save",
                    data: formData,
                    processData: false,
                    contentType: false,
                    dateType: "JSON",
                        ...
                        if (data.msg == "FAIL") {
                            ...
                            layer.msg("更新成功", {
                                ...
                                yes: function (index, layero) {
                                    ...
                                    window.location.href = "{{url(route_prefix() . '/news/news_add_browse')}}";
                                }
                            });
                        }
                    },
