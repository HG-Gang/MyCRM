            ...
            <form class="form form-horizontal" id="form-admin-add">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="" placeholder="账号" id="adminName" name="username">
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
                            <select class="select" name="role_id" size="1">
                                @foreach($role as $v)
                                <option value="{{$v->role_id}}" selected>{{$v->username}}</option>
                                @endforeach   
                            </select>
                        </span> </div>
                </div>
...
$(function () {
    ...
    $("#form-admin-add").validate({
        ...
        submitHandler: function (form) {
            $(form).ajaxSubmit({
                type: 'post',
                url: "{{url(route_prefix() . '/Administrators/addsave')}}",
                dataType: 'json',
